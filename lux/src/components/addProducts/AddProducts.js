...
const AddProducts = () => {
        ...
        async () => {
          try {
            ...
            if (currencies.Barter.selected) {
              ...
              productData.currencies.push(barterData);
            }

            if (currencies.STar.selected) {
              productData.currencies.push({
                currency: 'STar',
            ...
            if (currencies.LocalCurrency.selected) {
              ...
              productData.currencies.push(localCurrencyData);
            }                
              ...
              db.collection('Users')
                ...
                .then((doc) => {
                  if (doc.exists) {
                    ...
                    productData.username = userData.username;
                    productData.displayName = userData.displayName;
                    productData.address = userData.address;
                    productData.country = userData.country;
                    productData.phoneNumber = userData.phone || '';
  
                     // Add the user's city, state/union territory, and zip code to the product data
                    productData.city = userData.city;
                    productData.stateOrTerritory = userData.stateOrTerritory;
                    productData.zipCode = userData.zipCode;
  ...
  const totalProductQuantity = calculateTotalQuantity();
      ...
      <form autoComplete="off" className="form-group" onSubmit={handleAddProducts}>
        ...
        {totalProductQuantity > 0 && (
          <div className="total-quantity-info">
            Total Quantity: {totalProductQuantity}
          </div>
        )}
      </form>     
    </div>
