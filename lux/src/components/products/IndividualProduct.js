...
const IndividualProduct = ({ individualProduct, addToCart }) => {
  ...
  const handleAddToCart = (currencyType) => {
    addToCart(individualProduct, currencyType);
  };
  ...
  const handleDeleteAndReload = () => {
    handleDeleteProduct()
      .then(() => {
        removeFromCartAndDatabase(individualProduct.ID);
  ...
  const barterCurrency = individualProduct.currencies?.find((currency) => currency.currency === 'Barter');
  ...
  const localCurrency = individualProduct.currencies?.find((currency) => currency.currency === 'LocalCurrency');
    ...
    <div className="product">
      ...
      {showDetails && (
        <div>
          ...
          {individualProduct.currencies && (
            <div className="product-text price">
              {individualProduct.currencies.map((currency) => (
          ...
          <div className="product-text total-quantity">
            <strong>Total Quantity:</strong> {individualProduct.totalQuantity}
          </div>
          ...
          <div className="product-text uploader-info">
            <strong>Uploader:</strong> {individualProduct.username}
            <br />
            <strong>Display Name:</strong> {individualProduct.displayName}
            <br />
            <strong>Address:</strong> {individualProduct.address}
            <br />
            <strong>City:</strong> {individualProduct.city} {/* Display city */}
            <br />
            <strong>State/Union Territory:</strong> {individualProduct.stateOrTerritory} {/* Display state/union territory */}
            <br />
            <strong>Zip Code:</strong> {individualProduct.zipCode} {/* Display zip code */}
            <br />
            <strong>Country:</strong> {individualProduct.country}
            <br />
            <strong>Phone Number:</strong> {individualProduct.phoneNumber}
            <br />
            <strong>Email:</strong> {individualProduct.email}
          </div>
        </div>
      )}
      ...
      >
       ...
       {user && user.email === individualProduct.email ? (
        <button
