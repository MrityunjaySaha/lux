...
import traceback  # Import the traceback module for exception handling
...
class Cube:
    ...
    def draw(self, surface, eyes=False):
        ...
        if eyes:
            centre = dis // 2
            radius = 3
            circleMiddle = (i*dis+centre-radius, j*dis+centre-radius)
            circleMiddle2 = (i*dis + centre+radius, j*dis+centre-radius)
